...
const Newsletter = () => {
    return (
        <section className="text-gray-600 body-font md:px-5 lg:px-8 xl:px-44">
            <div className="container mx-auto  px-5 py-24 grid grid-cols-1 md:grid-cols-2">
                <div className=" mb-10 md:mb-0">
                    <img className="object-cover h-96 object-center rounded" alt="hero" src="https://demo.bosathemes.com/travele/wp-content/uploads/sites/13/2021/08/img5.jpg" />
                </div>
                <div className="lg:flex-grow  lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                    <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-800 font-extrabold">HOLIDAY SPECIAL 25% OFF !</h1>
                    <p className="mb-8 leading-relaxed">Sign up now to recieve hot special offers and information about the best tour packages, updates and discounts !!</p>
                    <div className="flex w-full md:justify-start justify-center items-end">
                        <div className="relative mr-4  lg:w-1/2 w-2/4">
                            
                            <input placeholder="Your Email Address" type="text" id="hero-field" name="hero-field" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:ring-2 focus:ring-indigo-200 focus:bg-transparent focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>
